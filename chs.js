...
var cnItems = {
    ...
    "A bathroom for rich people. Spacious, overdesigned, and extravagant. Enjoy your wealth from the comfort of your bathtub.": "有钱人的浴室。宽敞，过度设计和奢侈。在舒适的浴缸中享受您的财富。",
    "A cheap computer that enables you to do some work from home. 5% of your time at home contributes to time at work.": "一台便宜的电脑，可以让你在家做一些工作。 5% 的在家时间用于工作。",
    "A cheap futon. You can sleep in it, but you won't like it.": "便宜的蒲团。你可以睡在里面，但你不会喜欢它。",
    "A cheap kitchen area that allows for heating instant ramen and water for tea.": "一个便宜的厨房区域，可以加热方便面和茶水。",
    "A cheap kotatsu. It might burn you, but at least its warm in the winter.": "便宜的被炉。它可能会灼伤你，但至少在冬天它是温暖的。",
    "A decent computer that allows for some from home. 10% of your time at home contributes to time at work.": "一台体面的计算机，可以在家中进行一些操作。 10% 的在家时间用于工作。",
    "A high grade kitchen, with extra width for when you really need it.": "高档厨房，在您真正需要时有额外的宽度。",
    "A high grade kitchen. Please don't ask what qualifies as high grade because we don't know either.": "高档厨房。请不要问什么是高等级，因为我们也不知道。",
    "A kitchen of standard quality, but 50% wider!": "标准质量的厨房，但宽 50%！",
    "A kitchen of standard quality. Not too great, not too bad.": "标准品质的厨房。不算太好，也不算太差。",
    "A long but thin table; a comfortable gathering spot in the winter.": "一张长而薄的桌子；冬天舒适的聚会场所。",
    "A monstrous computer that allows for easy working from home. 22.5% of your time at home contributes to time at work.": "一台可让您在家轻松工作的巨型计算机。 22.5% 的在家时间用于工作。",
    "A nice futon for a nice rest.": "一个不错的蒲团，让您好好休息。",
    "A small, likely moldy tub, in a musky salmon color that ensures quick and unpleasant baths.": "一个可能发霉的小浴缸，呈麝香鲑鱼色，可确保快速和不愉快的沐浴。",
    "A standard tub found in many houses in Japan.": "在日本的许多房屋中都可以找到标准浴缸。",
    "A substantial upgrade from a cheap toilet. Be the you you want to be.": "从便宜的厕所大幅升级。成为你想成为的那个人。",
    "A super high grade kitchen area. You can feel the quality eminating from its glowing countertops.": "超高档厨房区。您可以感受到其发光的台面所散发出的品质。",
    "A super high grade kitchen, but with more width, to accomodate your massive house.": "超高档厨房，但宽度更大，可容纳您的大房子。",
    "A tub as large as can be in a 2x1 meter space. Comfortable and luxurious. It'll make you forget how small your tiny apartment really is.": "在 2x1 米的空间中可以放一个大浴缸。舒适豪华。它会让你忘记你的小公寓真的有多小。",
    "A tub for someone above average. Prove your worth to your guests when they glance a peek at your slightly superstandard bathtub.": "为高于平均水平的人准备的浴缸。当您的客人瞥一眼您略超标准的浴缸时，向他们证明您的价值。",
    "A very small tub that fits conveniently anywhere in a house.": "一个非常小的浴缸，可以方便地放在房子的任何地方。",
    "A wider cheap kitchen area that allows for heating instant ramen and water for tea, as well as some counter space.": "一个更宽敞的廉价厨房区域，可以加热方便面和茶水，以及一些柜台空间。",
    "An excellent toilet. Comes with all the add-ons you'd expect from a 20,000 yen toilet.": "一个很棒的厕所。附带所有您期望从 20,000 日元马桶中获得的附加组件。",
    "An extra large bathtub.It's not actually magic, but it will feel like it. It's not a bottle either, please understand.": "一个超大的浴缸。它实际上并不神奇，但感觉就像。也不是瓶子，请谅解。",
    "An ultra grade kitchen. Who knew there was a level even beyond super high grade?": "超高档厨房。谁知道还有超上品的层次？",
    "As the lowest level employee who isn't a regular Ippanshain, the Kakarichou's job is to mediate and serve as an informational pipeline between disgruntled employees and clueless upper management.": "作为不是普通 Ippanshain 的最低级别员工，Kakarichou 的工作是在心怀不满的员工和无知的高层管理人员之间进行调解并充当信息管道。",
    "Every feather in the Ultimate Down Futon was hand plucked by a Duck Expert for maximum softness, volume, and color.": "Ultimate Down Futon 中的每一根羽毛都由鸭子专家手工拔毛，以获得最大的柔软度、体积和颜色。",
    "First Class Bathroom Suite": "头等浴室套房",
    "It's a toilet. It's cheap. What more do you want?": "是厕所。它很便宜。你还想要什么？",
    "Magic Bottle Bathtub": "魔瓶浴缸",
    "Mediating": "调解",
    "Nice Futon": "漂亮的蒲团",
    "No one asked for this, but here it is! A kotatsu you can eat dinner at. Comes with 4 fancy chairs and a sense of decadence.": "没有人要这个，但它就在这里！可以吃晚餐的被炉。配有 4 把花哨的椅子和颓废感。",
    "Rotate": "旋转",
    "Spacious Apartment Bathtub": "宽敞公寓浴缸",
    "The ARDH improves significantly on previous models, its memory foam exterior ensures the perfect fit for every body shape. Bidet-included.": "ARDH 比以前的型号有了显着改进，其记忆泡沫外部确保完美贴合各种体型。包括坐浴盆。",
    "The ARDX Super is the latest in toilet technology. Shaped like a stasis pod, you'll forget what you were even doing in the first place.": "ARDX Super 是最新的马桶技术。形状像一个停滞舱，你会忘记你一开始在做什么。",
    "Time spent at home.\nWork from home bonus:00:00": "在家度过的时间。\n在家工作奖金：00:00",
    "Ultimate Down Futon": "终极羽绒被",
    "Used:": "用过的：",
    "With over 80 years of Kotatsu crafting experience, this hand-made charcoal kotatsu weighs as much as a grand piano. No idea if it's any good, though.": "这款手工制作的木炭被炉拥有 80 多年的被炉制作经验，重量相当于一架三角钢琴。不过不知道好不好。",
    "You currently get a Relationship Point boost of 0.07 per day by spending 01:00 at home.": "目前，您在家中消费 01:00 可获得每天 0.07 的关系点提升。",
    "You currently get an Efficiency boost of x1.11 from the comfortability of your home.": "目前，您从舒适的家中获得了 x1.11 的效率提升。",
    "Your mother is starting to get fed up! Get married in the next 3 years or else!": "你妈妈开始受够了！ 3年内结婚，否则！",
    "": "",
    "": "",
    "": "",
    "": "",
...
var cnPrefix = {
    ...
    "Wife:": "妻子:",
    "Birthday:": "生日:",
    "You are officially better than other people now. But with more effort you could be promoted to a full-fledged Deputy Manager:Kachoudairi.": "你现在比其他人好。但如果你付出更多努力，你可能会被提升为一名成熟的副经理：副经理。",
    "Points:": "点数：",
    "": "",
    "": "",
    "": "",
